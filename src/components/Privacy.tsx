...
const Privacy = () => {
    ...
    return (
        <>
            <section className="container-main" id="privacy" ref={privacyRef} title="Документы конфиденциальности">
                ...
                <p style={{ textAlign: 'justify', lineHeight: '30px', marginBottom: '50px' }}>1. Общие положения <br /> <br />
                    ...
                    <br />12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://robotic.ru/privacy.</p>
            </section>
        </>
    )
}
